...
class SpringBootAPIApplicationTests {
	...
	public void setup() {
		...
		movieRepository.save(new Movie(2003, "Title 11", "Studio 4", "Consecutive Producer 2", true));

		movieRepository.save(new Movie(2001, "Title 12", "Studio 3", "Consecutive Producer 3", true));
		movieRepository.save(new Movie(2022, "Title 13", "Studio 3", "Consecutive Producer 3", true));
		movieRepository.save(new Movie(2023, "Title 14", "Studio 3", "Consecutive Producer 3", true));
	}
